...
class Mepu_Woo_Additional_Fields
{
    ...
    ?>
        <div class="options_group show_if_external mepu-woo-cont" style="padding:0px 10px;">
            <h4><?php _e('Multiple external product URLs','mepu-woo'); ?> - <a href="#mepu-woo-data" class="mepu-woo-add"><?php _e('Add new','mepu-woo'); ?></a></h4>
            <?php
            ...
            <div class="hidden mepu-woo-only-for-clone" style="border-bottom:1px solid #efefef;">
                <h5><?php _e('## External / Affiliate product details','mepu-woo'); ?> - <a href="#mepu-woo-data" class="mepu-woo-delete"><?php _e('Delete','mepu-woo'); ?></a></h5>
                <?php
